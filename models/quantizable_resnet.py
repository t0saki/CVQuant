"""
Quantizable ResNet implementation with QuantStub and DeQuantStub
Based on the PyTorch ResNet implementation with modifications for quantization
"""
...
def _resnet(
    ...
    **kwargs: Any
    ...
    if pretrained:
        ...
        # Also filter out fc layer if num_classes doesn't match
        state_dict_filtered = {}
        for key, value in state_dict.items():
            if not (key.startswith('quant') or key.startswith('dequant')):
                # Skip fc layer if the number of classes doesn't match
...
class CifarResNet(ResNet):
    ...
    def __init__(
        ...
        # Modified for CIFAR-10: 3x3 conv with stride=1, no maxpool
...
def _cifar_resnet(
    ...
    **kwargs: Any
    ...
    # Note: CIFAR-10 adapted models don't use ImageNet pretrained weights
